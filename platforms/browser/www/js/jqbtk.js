...
(function($) {
    $.fn.keyboard = function(options) {
        ...
        if (!settings.layout) {
            ...
            } else if (($(this).attr('type') === 'tel' && $(this).hasClass('keyboard-tel')) || settings.type === 'tel') {
                settings.layout = settings.telLayout;
            } else if(($(this).attr('type') === 'tel' && $(this).hasClass('calc-numpad'))){
                settings.layout = settings.calcLayout;
            } else if(($(this).attr('type') === 'tel' && $(this).hasClass('keyboard-int'))){
              settings.layout = settings.intLayout;
            }
            else {
