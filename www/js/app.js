...
freeMenu = '<li class="menu-division menu-division ui-li-static ui-body-inherit freeApp"></li>' +
  '<li><a href="#metodo-t" class="ui-btn ui-btn-icon-right ui-icon-carat-r freeApp">Tee</a></li>' +
...
activeSubscriptionMenu = '<li><a href="#Larco" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Longitud Real<br> "Removibles"</a></li>' +
  ...
  '<li><a href="#metodo-t" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Tee</a></li>' +
  '<li><a href="#metodo-montura" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Montura</a></li>' +
  '<li><a href="#metodo-y" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Yee</a></li>' +
  '<li><a href="#metodo-y-desigual" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Yee Desigual</a></li>' +
  '<li><a href="#metodo-90" class="ui-btn ui-btn-icon-right ui-icon-carat-r">90 en 4 Partes</a></li>' +
  '<li><a href="#gajos-90" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Gajos de Insulación <br> para 90s </a></li>' +
  '<li><a href="#metodo-aguila" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Montura al Revés</a></li>' +
  '<li><a href="#stove-90" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Stove Pipe 90 Grados</a></li>' +
  '<li><a href="#stove-45" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Stove Pipe 45 Grados</a></li>' +
  '<li><a href="#trompa-marrano" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Trompa de Marrano</a></li>' +
  '<li><a href="#rectangulo-redondo" class="ui-btn ui-btn-icon-right ui-icon-carat-r">(Rectángulo o Cuadrado) a <br>Redondo</a></li>' +
  '<li><a href="#redondo-rectangulo" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Redondo a (Rectángulo o<br> Cuadrado)</a></li>' +
  '<li><a href="#pantalon-45" class="ui-btn ui-btn-icon-right ui-icon-carat-r">Pantalón Pipas Iguales 45°</a></li>' +
  '<li class="menu-division ui-li-static ui-body-inherit"></li>';

subscriptionScreen = '<h3 class="text-center red">Suscripción activa</h3><div id="subData"></div>';

allPatterns = '<div class="row no-margin">' +
  '                <div class="col-xs-6">' +
  '                    <a href="#metodo-t"><img class="center-block menu-item img-responsive" src="img/menu/metodoT.jpg"' +
  '                                             alt=""><div class="bottom-center">Tee</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#metodo-montura"><img class="center-block menu-item img-responsive"' +
  '                                                   src="img/menu/montura.jpg"' +
  '                                                   alt=""><div class="bottom-center">Montura</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#metodo-y"><img class="center-block menu-item img-responsive" src="img/menu/metodo_Y.jpg"' +
  '                                             alt=""><div class="bottom-center">Yee</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#metodo-y-desigual"><img class="center-block menu-item img-responsive"' +
  '                                                      src="img/menu/Y_desigual.jpg"' +
  '                                                      alt=""><div class="bottom-center">Yee Desigual</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#metodo-90"><img class="center-block menu-item img-responsive" src="img/menu/metodo_90.jpg"' +
  '                                              alt=""><div class="bottom-center">90 en 4</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#metodo-aguila"><img class="center-block menu-item img-responsive"' +
  '                                                  src="img/menu/montura_alreves.jpg"' +
  '                                                  alt=""><div class="bottom-center">Montura al Revés</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#stove-90"><img class="center-block menu-item img-responsive"' +
  '                                             src="img/menu/stovepipe90.jpg" alt=""><div class="bottom-center">Stove Pipe 90°</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#stove-45"><img class="center-block menu-item img-responsive"' +
  '                                             src="img/menu/stovepipe45.jpg" alt=""><div class="bottom-center">Stove Pipe 45°</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#trompa-marrano"><img class="center-block menu-item img-responsive"' +
  '                                                   src="img/menu/trompademarrano.jpg" alt=""><div class="bottom-center">Trompa de Marrano</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#rectangulo-redondo"><img class="center-block menu-item img-responsive"' +
  '                                                       src="img/menu/rectangulo_redondo.jpg" alt=""><div class="bottom-center">Rectángulo a Redondo</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#redondo-rectangulo"><img class="center-block menu-item img-responsive"' +
  '                                                       src="img/menu/redondoa_rectangulo.jpg" alt=""><div class="bottom-center">Redondo a Rectángulo</div></a>' +
  '                </div>' +
  '                <div class="col-xs-6">' +
  '                    <a href="#pantalon-45"><img class="center-block menu-item img-responsive"' +
  '                                                src="img/menu/pantalon.jpg"' +
  '                                                alt=""><div class="bottom-center">Pantalón 45°</div></a>' +
  '                </div>' +
  '            </div>' +
...
function convertToFraction($number) {
    if($number % 1 === 0) {
        ...
        } else if ($compare >= .75 && $compare <= .8125) {
            $min = $compare - .75;
            $max = .8125 - $compare;
            if ($min < $max) {
                $result = '3/4';
...
function calculoMetodoMarrano($circ1, $circ2, $length){
  $d = Math.round( $circ1 / Math.PI );
  $d2 = Math.round( $circ2 / Math.PI );
  $espacio = convertToFraction( ( $circ1 / 12 ) );
  $angle = Math.atan(($d - $d2)/$length);
  $baseMenor = $d2/Math.tan($angle);
  ...
  for(var i = 0; i < 7; i++) {
    ...
    $shorts.push(convertToFraction(Math.sqrt($short)));
    $longs.push(convertToFraction(Math.sqrt($long)));
  }
  ...
  $ax1=convertToDecimal($shorts[0]);
  $Ax1=convertToDecimal($longs[0]);

  $ax2=convertToDecimal($shorts[1]);
  $Ax2=convertToDecimal($longs[1]);

  $ax3=convertToDecimal($shorts[2]);
  $Ax3=convertToDecimal($longs[2]);

  $ax4=convertToDecimal($shorts[3]);
  $Ax4=convertToDecimal($longs[3]);

  $ax5=convertToDecimal($shorts[4]);
  $Ax5=convertToDecimal($longs[4]);

  $ax6=convertToDecimal($shorts[5]);
  $Ax6=convertToDecimal($longs[5]);

  $ax7=convertToDecimal($shorts[6]);
  $Ax7=convertToDecimal($longs[6]);
  ...
  function getRightX(r,b,x){
      $x = (Math.sqrt(Math.pow(r,2)-Math.pow(b,2)))-x;
      $x = convertToFraction($x);
    return convertToDecimal($x);
  }


  $y2a = getRightY($Ax1, 0, $espacioDecimal, $Ax2);
  $x2a = getRightX($Ax2, $y2a, $ax1);

  $y3a = getRightY(($x2a+$ax1), $y2a, $espacioDecimal, $Ax3);
  $x3a = getRightX($Ax3, $y3a, $ax1);

  $y4a = getRightY(($x3a+$ax1), $y3a, $espacioDecimal, $Ax4);
  $x4a = getRightX($Ax4, $y4a, $ax1);

  $y5a = getRightY(($x4a+$ax1), $y4a, $espacioDecimal, $Ax5);
  $x5a = getRightX($Ax5, $y5a, $ax1);

  $y6a = getRightY(($x5a+$ax1), $y5a, $espacioDecimal, $Ax6);
  $x6a = getRightX($Ax6, $y6a, $ax1);

  $y7a = getRightY(($x6a+$ax1), $y6a, $espacioDecimal, $Ax7);
  $x7a = getRightX($Ax7, $y7a, $ax1);

  $angle1b = Math.atan(($y2a/($x2a+$ax1)));
  $x2b = Math.cos($angle1b)*$ax2 - $ax1;
  $y2b = Math.sin($angle1b)*$ax2;

  $angle2b = Math.atan(($y3a/($x3a+$ax1)));
  $x3b = Math.cos($angle2b)*$ax3 - $ax3;
  $y3b = Math.sin($angle2b)*$ax3;

  $angle3b = Math.atan(($y4a/($x4a+$ax1)));
  $x4b = Math.cos($angle3b)*$ax4 - $ax1;
  $y4b = Math.sin($angle3b)*$ax4;

  $angle4b = Math.atan(($y5a/($x5a+$ax1)));
  $x5b = Math.cos($angle4b)*$ax5 - $ax1;
  $y5b = Math.sin($angle4b)*$ax5;

  $angle5b = Math.atan(($y6a/($x6a+$ax1)));
  $x6b = Math.cos($angle5b)*$ax6 - $ax1;
  $y6b = Math.sin($angle5b)*$ax6;

  $angle6b = Math.atan(($y7a/($x7a+$ax1)));
  $x7b = Math.cos($angle6b)*$ax7 - $ax1;
